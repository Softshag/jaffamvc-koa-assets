...
const jaffamvc = require('jaffamvc-koa'),
...
module.exports = function(opt) {
  ...
  return function () {
    ...
    this.assets.routes = {
      ...
      client_css: function (options) {
        return routes.client_css(assets, options);
      },
      client_mime: function (options) {
        return routes.client_mime(assets, options);
      }
    };

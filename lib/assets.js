...
assign(Assets.prototype, {
  ...
  remove: function (path) {
    return co(function *() {
      ...
      if (this.meta && options.skipMeta !== true) {
  ...
  _runmds: function (asset, tmp) {
    return co(function *() {
      ...
      for (i=0;i<this._mds;i++) {
        ...
        if (utils.isYieldable(md)) {
          yield md.call(this.app, asset);
        } else {
          md.call(this.app, asset);
        }
      }

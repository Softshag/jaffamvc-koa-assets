...
assign(Assets.prototype, {
  ...
  create: function (stream, path, options) {
    ...
    return co(function *() {
      ...
      if (self.metaStore) {
        asset = yield self.metaStore.create(asset, options);
      }
  ...
  remove: function (path) {
    return co(function *() {
      ...
      if (this.metaStore) {
        yield this.metaStore.remove(path);
      }
  ...
  list: function () {
    return co(function *() {
      ...
      if (this.metaStore) {
        return yield this.metaStore.list();
      }

      return yield this.store.list();
    }.bind);
  ...
  get: function (path) {
    if (this.metaStore) {
      return this.metaStore.find(path);
    }
